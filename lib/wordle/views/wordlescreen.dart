...
class _WordleScreenState extends State<WordleScreen> {
  ...
  final List <Word> _board = List.generate(6, (_) => Word(letters: List.generate(5,(_) =>
      Letter.empty())),);
 ...
 Future <void> _onEnterTapped() async{
    ...
    for (var i = 0; i < _currentWord!.letters.length; i++){
      ...
      final letter = _keyboardLetters.firstWhere((e) =>
      e.val == currentWordLetter.val,
      orElse: () => Letter.empty(),
      );
